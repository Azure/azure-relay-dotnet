...
// From https://github.com/dotnet/corefx/blob/master/src/System.ValueTuple/src/System/ValueTuple/ValueTuple.cs
namespace System
{
    /// <summary>
        ...
        : IEquatable<ValueTuple<T1, T2>>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<ValueTuple<T1, T2>>, ITupleInternal
    {
        ...
        int IComparable.CompareTo(object other)
        {
            ...
            {
                throw new ArgumentException(SR.GetString(SR.ArgumentException_ValueTupleIncorrectType, typeof(ValueTuple<T1, T2>)), nameof(other));
            }
